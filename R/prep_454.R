#' standard preprocessor for 454 sequencing reads in BiMiCo pipeline
#'
...
#'
#' @param readfiles (Required) Path to 454 demultiplexed fastq files
#' @param outdir (Required) String specifying output directory for processed files.
...
prep_454 <- function(readfiles, outdir, file_suffix=".fastq", mtthread=F, trim_read_length=0, trim5end=0){
