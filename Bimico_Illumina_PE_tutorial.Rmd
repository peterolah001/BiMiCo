...
The current tutorial and example data is aimed at the simple preprocessing of 16S Illumina PE fastq data. For more options and details, please see the "BiMiCo_tutorial_EXTENDED" document.
...
t1c <- sapply(t1b, function(x) (x / sum(x))*100)
colSums(t1c)
...
#### D) Further visualizations and data transformations provided in the "Visualizations_Bimico" R script
